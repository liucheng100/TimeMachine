            ...
            <template v-slot:tab0>
                <div class="prize4_card">
                    <cardMini @click="$router.push({
                        path: '/WorkDetail',
                        query: { workId: i.workId }
                    })" :key="idx" v-for="(i, idx) in prize4List_df" :title=i.title :auth=i.auth :avatar=i.avatar :hot=i.hot
                        :cover=i.cover>
                    </cardMini>
                </div>
            </template>
            <template v-slot:tab1>
                <div class="prize4_card">
                    <cardMini @click="$router.push({
                        path: '/WorkDetail',
                        query: { workId: i.workId }
                    })" v-for="i in prize4List_ssp" :title=i.title :auth=i.auth :avatar=i.avatar :hot=i.hot :cover=i.cover>
                    </cardMini>
                </div>
            </template>
            <template v-slot:tab2>
                <div class="prize4_card">
                    <cardMini @click="$router.push({
                        path: '/WorkDetail',
                        query: { workId: i.workId }
                    })" v-for="i in prize4List_dsp" :title=i.title :auth=i.auth :avatar=i.avatar :hot=i.hot :cover=i.cover>
                    </cardMini>
                </div>
            </template>
            <template v-slot:tab3>
                <div class="prize4_card">
                    <cardMini @click="$router.push({
                        path: '/WorkDetail',
                        query: { workId: i.workId }
                    })" v-for="i in prize4List_ai" :title=i.title :auth=i.auth :avatar=i.avatar :hot=i.hot :cover=i.cover>
                    </cardMini>
                </div>
            </template>
        </TabMagic>
