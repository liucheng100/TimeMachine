<template>
    <div class="fileList">
        ...
        <el-table :data="tableData" border empty-text="暂无数据" ref="multipleTableRef" v-if="!isChecking && !isEditing"
            ...
            <el-table-column prop="name_post" label="发件人" />
            <el-table-column prop="title" label="标题" />
            <el-table-column prop="time" label="时间" sortable><template #default="scope">{{
                    scope.row.time.split(".")[0].split("T").join(" ")
                    }}</template></el-table-column>
            <el-table-column prop="name_handle" label="处理人" />
            <el-table-column prop="attachment" label="" width="200">
                <template #default="scope">
                    <el-button auto-insert-space @click="check(1)">查看</el-button>
                    <el-button auto-insert-space @click="edit(1)">回复</el-button>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                tableData: [
                    { name_post: "aa", name_handle: "aa", title: "aa", time: "2000-01-01" },
                    { name_post: "bb", name_handle: "aa", title: "aa", time: "2000-01-02" },
                    { name_post: "cc", name_handle: "aa", title: "aa", time: "2000-01-05" },
                    { name_post: "dd", name_handle: "aa", title: "aa", time: "2000-01-04" },
                ],
                multipleSelection: [],
                isChecking: false,
                isEditing: false,
