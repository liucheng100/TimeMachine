        ...
        <div class="medal-setting">
            <TabMagic :id="3" backColor="transparent" :title_list="['单反组','随手拍组','短视频组']" @tab0Click="state_part=0"
                ...
                <template v-slot:tab0>
                    <div class="prize-box">
                        <PartPrize v-for="(item,index) in prizes[0]" :key="item.prize_name"
                            :prize_name="item.prize_name" :medal_name="item.medal_name"
                            :medal_member="item.medal_member" @click="prizeSettingOpen(index, 0)"></PartPrize>
                    </div>
                </template>
        ...
        <transition name="pop">
            <div class="medal" v-show="if_mask_layer">
                ...
                <div class="text-input">
                    ...
                    <input type="number" placeholder="只填阿拉伯数字" class="input-content"
                        v-model="medal_setting.medal_member" />
                </div>
                <div class="text-input">
                    <p class="title pop-title">奖品名称</p>
                    <input type="text" placeholder="如DJI Pocket" class="input-content"
                        v-model="medal_setting.prize_name" />
                </div>
                <div class="text-input">
